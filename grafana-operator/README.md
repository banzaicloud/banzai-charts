...
| `defaultDeployment.ingress.annotations`               | Additional annotations for Default Grafana Instance Ingress                                          | `true`                                                  |
...
| `defaultDeployment.service.annotations`               | Additional annotations for Default Grafana Instance Service                                          | `true`                                                  |
