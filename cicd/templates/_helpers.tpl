...
{{- define "cicd.database.name" -}}
{{- if .Values.database.name -}}
{{- .Values.database.name -}}
{{- else if .Values.cloudsql.enabled -}}
{{- required "Please specify database name" .Values.database.name -}}
{{- else if and .Values.mysql.enabled ( eq (include "cicd.database.driver" .) "mysql") -}}
{{- .Values.mysql.mysqlDatabase -}}
{{- else if and .Values.postgres.enabled (eq (include "cicd.database.driver" .) "postgres") -}}
...
{{- define "cicd.database.secretName" -}}
{{- if .Values.database.existingSecret -}}
{{- .Values.database.existingSecret -}}
{{- else if .Values.database.password -}}
{{- printf "%s-database" (include "cicd.fullname" .) -}}
{{- else if .Values.cloudsql.enabled -}}
{{- fail "Please specify database password or existing secret" -}}
{{- else if and .Values.mysql.enabled ( eq (include "cicd.database.driver" .) "mysql") -}}
...
{{- define "cicd.database.secretKey" -}}
