...
| `kubernetes.hostname`                  | Hostname that Traefik will add to the status section of Ingress objects that it manages.                                     | None                                              |
| `kubernetes.ip`                        | IP address that Traefik will add to the status section of Ingress objects that it manages.                                   | None                                              |
| `kubernetes.publishedService`          | The service name, which traefik will copy the status spec from. `namespace/servicename"`                                     | `{{ template "traefik.fullname" . }}`             |
