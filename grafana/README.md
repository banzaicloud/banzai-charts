...
| `sidecar.dashboards.namespace`  | The sidecar will search for config-maps inside this namespace. | The namespace in which the sidecar is running will be used |
...
| `sidecar.datasources.namespace` | The sidecar will search for config-maps inside this namespace. | The namespace in which the sidecar is running will be used |
